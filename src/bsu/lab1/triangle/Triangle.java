...
public class Triangle {
    ...
    public void calculate() {
        ...
        this.perimeter = calculateThePerimeter(side1, side2, side3);
        this.square = calculateTheSquare(side1, side2, side3, perimeter);
        this.type = calculateTheType(side1, side2, side3);
    }

    public double calculateThePerimeter(double side1, double side2, double side3){
        return (side1 + side2 + side3);
    }

    public double calculateTheSquare(double side1, double side2, double side3, double perimeter){
        return (Math.sqrt((perimeter / 2) * ((perimeter / 2) - side1) *
                (perimeter / 2 - side2) * (perimeter / 2 - side3)));
    }

    public String calculateTheType(double side1, double side2, double side3){
